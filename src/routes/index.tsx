      ...
      <div className="grid gap-12 lg:grid-cols-[1.5fr_1fr] lg:gap-20">
            ...
            <span className="relative inline-block group/merlin">
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 z-20 pointer-events-none opacity-0 scale-90 transition-all duration-200 ease-out group-hover/merlin:opacity-100 group-hover/merlin:scale-100 rotate-[5deg]">
                <div className="w-28 h-28 rounded-xl overflow-hidden shadow-lg">
                  <img src="https://res.cloudinary.com/n72bnmrl/image/upload/v1783382955/merlin_hover_inrjoz.png" alt="Merlin" className="w-full h-full object-cover" />
                </div>
              </div>
            </span>
        ...
        <div className="relative h-[400px] lg:h-[420px]">
          ...
          >
            ...
            >
              <div className="absolute inset-0 rounded-2xl overflow-hidden" style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden" }}>
                <img src="https://res.cloudinary.com/n72bnmrl/image/upload/v1783382963/About02_Static_nqtf9b.png" alt="About" className="w-full h-full object-cover" />
              </div>
              <div className="absolute inset-0 rounded-2xl overflow-hidden" style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", transform: "rotateY(180deg)" }}>
                <img src="https://res.cloudinary.com/n72bnmrl/image/upload/v1783382956/About02_Hover_ubz2gq.png" alt="About" className="w-full h-full object-cover" />
              </div>
            </motion.div>
            {cursor.card === 0 && (
              <motion.div
          ...
          >
            ...
            >
              <div className="absolute inset-0 rounded-2xl overflow-hidden" style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden" }}>
                <img src="https://res.cloudinary.com/n72bnmrl/image/upload/v1783382943/About01_Static_klt8zn.png" alt="About" className="w-full h-full object-cover" />
              </div>
              <div className="absolute inset-0 rounded-2xl overflow-hidden" style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", transform: "rotateY(180deg)" }}>
                <img src="https://res.cloudinary.com/n72bnmrl/image/upload/v1783382944/About01_Hover_u22inb.png" alt="About" className="w-full h-full object-cover" />
              </div>
            </motion.div>
            {cursor.card === 1 && (
              <motion.div
