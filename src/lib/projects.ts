...
export const projects: Project[] = [
  {
    ...
    heroVideo: "/content/Auth0_Hero01.mp4",
    ...
    brand: "Auth0",
    bg: "#0A0A14",
    cardBg: "/content/Auth0_CardBackground.png",
    cardImage: "/content/Auth0_CardImage.png",
    cardImageOffsetY: 40,
    narrative:
    ...
    sections: [
      {
        ...
        noCols: true,
        breakImage: "/content/Auth0_Example02.png",
        breakVideo2: "/content/Auth0_Retail_01.mp4",
        breakSplit: true,
        breakVideo3: "/content/Auth0_Example03.mp4",
        breakImage4: "/content/Auth0_Example04.png",
        breakPlaceholders: 2,
      },
      {
        ...
        cardPreview: true,
        breakImage: "/content/A4AA_Example01.png",
      },
    ],
  },
  {
    slug: "okta-web-motion",
    heroVideo: "/content/Okta_Hero01.mp4",
    ...
    brand: "Okta",
    bg: "#ECE8E4",
    cardImage: "/content/Okta_CardImage.png",
    stats: [
    ...
    sections: [
      {
        ...
        image: "/content/Oktane_Example01.png",
        breakVideo: "/content/Oktane_Example02.mp4",
      },
      {
        ...
        breakVideo: "/content/Okta_Example02.mp4",
        noCols: true,
      },
      {
        ...
        breakVideo: "/content/Okta_Example01.mp4",
        noCols: true,
      },
    ],
  },
  {
    ...
    hideStatGroups: true,
    brand: "Studeo",
    heroVideo: "/content/Studeo_MainWork_Intro.mp4",
    bg: "#ECE4FF",
    cardImage: "/content/Studeo_CardImage.png",
    stats: [
    ...
    sections: [
      {
        ...
        image: "/content/StudeoAds_1.png",
        breakImage: "/content/StudeoAds_2.png",
      },
      {
        heading: "Landing Pages & Explainer Video",
        video: "/content/StudeoMotion_01.mp4",
        breakVideo: "/content/StudeoMotion_02.mp4",
      ...
      },
      {
        ...
        image: "/content/StudeoWeb_1.png",
        breakVideo: "/content/StudeoWeb_02.mp4",
      },
    ],
  },
  {
    ...
    timeline: "2024 — 2025",
    brand: "Malleable",
    heroImage: "/content/Malleable_Hero_01.png",
    bg: "#C6D6FF",
    cardImage: "/content/Malleable_CardImage.png",
    stats: [
    ...
    sections: [
      {
        ...
        image: "/content/Malleable_Example02.png",
      },
      {
        heading: "Brand & web",
        ...
        noCols: true,
        breakImage: "/content/Malleable_Example01.png",
        breakImage2: "/content/Malleable_Example03.png",
      },
    ],
  },
];
